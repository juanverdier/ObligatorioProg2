...
class MyHeapImplTest {
    ...
    void insert() {
        ...
        MyHeap<Integer> heapMax = new MyHeapImpl<>(arrayUno,true);
        ...
        MyHeap<Integer> heapMin = new MyHeapImpl<>(arrayDos,false);
    ...
    void deleteAndReturn() {
        ...
        Integer[] arrayUno = new Integer[15];
        MyHeap<Integer> heapMax = new MyHeapImpl<>(arrayUno,true);    // Prueba del Heap Max
        ...
        Integer[] arrayDos = new Integer[15];
        MyHeap<Integer> heapMin = new MyHeapImpl<>(arrayDos,false);    // Prueba del Heap Min
    ...
    void size() {
        ...
        Integer[] arrayUno = new Integer[15];
        MyHeap<Integer> heap = new MyHeapImpl<>(arrayUno,true);   // Size es lo mismo para cualquier tipo de Heap
    ...
    void testToString() {
        ...
        Integer[] arrayUno = new Integer[15];
        MyHeap<Integer> heap = new MyHeapImpl<>(arrayUno,true); // toString es lo mismo para cualquier tipo de Heap
